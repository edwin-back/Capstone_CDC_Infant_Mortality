...
del_age = plot_ly(Del_Edu18, x = ~delivery_payment_source, y = ~fathers_age_average, type = 'bar', name = 'Fathers Age')
...
# att_ed <- plot_ly(Del_Edu18, x = ~attendant_at_birth, y = ~fathers_education_average, type = 'bar', name = 'Fathers Education')
...
# att_ed
# 
# att_age <- plot_ly(Del_Edu18, x = ~attendant_at_birth, y = ~fathers_age_average, type = 'bar', name = 'Fathers Age')
...
# del_bmi
# 
# # att_bmi <- plot_ly(Del_hist18, x = ~attendant_at_birth, y = ~mothers_bmi_average, type = 'bar', name = 'Mothers BMI')
...
prenatal_education_mother18= nat18 %>% 
  group_by(mothers_education) %>% 
  summarise_at(vars(n_prenatal_visits, fathers_education, mothers_age, fathers_age),
               list(average = mean))
...
# prenatal_ed_mother= ggplot(prenatal_education_mother18, aes(x=mothers_education, y=n_prenatal_visits_average, group=1)) +
#   geom_line()+
#   geom_point()
# 
# prenatal_ed_mother
...
# prenatal_education_father18= nat18 %>% 
#   group_by(fathers_education) %>% 
#   summarise_at(vars(n_prenatal_visits, mothers_education, mothers_age, fathers_age),
#                list(average = mean))
# 
# prenatal_ed_father= ggplot(prenatal_education_father18, aes(x=fathers_education, y=n_prenatal_visits_average, group=1)) +
#   geom_line()+
#   geom_point()
# 
# prenatal_ed_father
...
# 
# prenatal_history_bmi18= nat18 %>% 
#   group_by(mothers_bmi) %>% 
#   summarise_at(vars(n_prenatal_visits, pre_preg_lbs, delivery_lbs),
#                list(average = mean))
# 
# View(prenatal_history18)
# 
# 
# prenatal_bmi= ggplot(prenatal_history_bmi18, aes(x=mothers_bmi, y=n_prenatal_visits_average, group=1)) +
#   geom_line()+
#   geom_point()
# 
# prenatal_bmi
# 
# 
# prenatal_history_pre18= nat18 %>% 
#   group_by(pre_preg_lbs) %>% 
#   summarise_at(vars(mothers_bmi, n_prenatal_visits, delivery_lbs),
#                list(average = mean))
# 
# View(prenatal_history_pre18)
# 
# prenatal_pre_preg= ggplot(prenatal_history_pre18, aes(x=pre_preg_lbs, y=n_prenatal_visits_average, group=1)) +
#   geom_line()+
#   geom_point()
# 
# prenatal_pre_preg
...
# 
# 
# prenatal_history_del18= nat18 %>% 
#   group_by(delivery_lbs) %>% 
#   summarise_at(vars(mothers_bmi, pre_preg_lbs, n_prenatal_visits),
#                list(average = mean))
# 
# 
# prenatal_delivery= ggplot(prenatal_history_del18, aes(x=delivery_lbs, y=n_prenatal_visits_average, group=1)) +
#   geom_line()+
#   geom_point()
# 
# prenatal_delivery
...
View(paternity_education18)

paternity_education18_no1= paternity_education18[-c(1), ]

View(paternity_education18_no1)
...
# pat_ed <- plot_ly(paternity_education18_no1, x = ~paternity_acknow, y = ~mothers_education_average, type = 'bar', name = 'Mothers Education')
...
pat_age <- plot_ly(paternity_education18_no1, x = ~paternity_acknow, y = ~mothers_age_average, type = 'bar', name = 'Mothers Age')
...
paternity_history18_no1= paternity_history18[-c(1), ]

View(paternity_history18_no1)

pat_bmi <- plot_ly(paternity_history18_no1, x = ~paternity_acknow, y = ~mothers_bmi_average, type = 'bar', name = 'Mothers BMI')
